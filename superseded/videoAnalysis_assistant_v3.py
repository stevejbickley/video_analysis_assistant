    ...
    "properties": {
        ...
        "activity_event_actions": {
            ...
            "items": {
                ...
                "required": ["activity_event_action"],
                "additionalProperties": False
            }
        },
        "scene_background_contexts": {
            "type": "array",
            "items": {
                "type": "object",
                "properties": {
                ...
                "required": ["scene_background_context"],
                "additionalProperties": False
            }
        },
        "behavioural_nudge_device_or_moral_suasions": {
            "type": "array",
            "items": {
                "type": "object",
                "properties": {
                ...
                "required": ["behavioural_nudge_device_or_moral_suasion"],
                "additionalProperties": False
            }
        }
    },
    "required": ["timestamps", "activity_event_actions", "scene_background_contexts", "behavioural_nudge_device_or_moral_suasions"],
    "additionalProperties": False
}
